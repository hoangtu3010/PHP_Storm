...
<body>
<div class="container">
    <h2 style="margin-top: 20px; padding: 10px 0; border-bottom: 2px solid cadetblue;" >Thêm mới sản phẩm</h2>
    <form action="luusanpham.php" method="post" style="margin-top: 40px" class="row g-3 needs-validation" novalidate>
        <div class="col-md-4">

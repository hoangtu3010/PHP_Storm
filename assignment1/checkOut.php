            ...
            <table class="table table-striped table-hover">
                ...
                <?php foreach ($ds as $item){ ?>
                    <tr>
                        ...
                        <!--                            <td class="text-center"><button class="btn btn-light button-mp">-</button> <input class="input-amount" type="number" name="quantity" value='1'  /> <button class="btn btn-light button-mp">+</button></td>-->

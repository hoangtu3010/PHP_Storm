...
<body>
    <?php
        ...
        if ($ct == null) header("location: listCategory.php");
    ?>
    <div class="container">
        <h2 style="margin-top: 20px; padding: 10px 0; border-bottom: 2px solid cadetblue;" >Sửa Category</h2>
        <form action="updateCategory.php" method="post" style="margin-top: 40px" class="row g-3 needs-validation" novalidate>
